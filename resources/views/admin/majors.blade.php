...
@section('sidebar')
    @include('layout.adminAside', ['title' => 'enterprise', 'subtitle'=>'major', 'username' => $data['username']])
@endsection
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    html += "<tr>" +
                        ...
                        "</tr>";
                    html += "<tr>" +
                        "<td colspan='2'>专业认证照片</td></tr>" +
                        "<tr><td colspan='2'><img src=" + userinfo['majors_photo'] + " width='100%'/></td>" +
                        "</tr>";
