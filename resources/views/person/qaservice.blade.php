    ...
    <div class="main-wrap">
        ...
        <div class="authentication">
            @if($data["is_vertify"] == -1 || $data["is_vertify"] == 2)
                <p class="tip">自愿提供身份证信息，若愿意增加信用度，可上传您身份证上的真实信息(选填)</p>
                <div class="authenticationInfo">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-form-content">
                            <input type="text" id="real-name" name="real_name" placeholder="请输入您的真实姓名(选填)">
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-IDcard" class="am-form-label">身份证号</label>
                        <div class="am-form-content">
                            <input type="text" id="id-card" name="id_card" placeholder="请输入您的身份证信息(选填)">
                        </div>
                    </div>
                    <div class="am-form-group">
                ...
                <div class="authenticationPic">
                    ...
                    <div class="authenticationPic">
                    <p class="title">自愿上传 学生证、毕业证、职称证、资格证或者其它技能证书（选填）</p>
