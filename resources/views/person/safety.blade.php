                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="m-left">
                                ...
                                @if($data['userinfo']->mail_verify == 1)
                                    <div class="fore2"><small>您验证的邮箱:{{substr(explode('@',$data['userinfo']->mail)[0],0,3)}}xxxx@ {{explode('@',$data['userinfo']->mail)[2]}}若已丢失或停用，请立即更换</small></div>
                                @else
