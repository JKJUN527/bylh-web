...
<div class="hmtop">
    ...
    <div class="am-container header">
        ...
        <ul class="message-r">
            ...
            @else
                <div class="topMessage my-shangcheng">
                    <div class="menu-hd MyShangcheng"><a href="{{asset('/account/index')}}" target="_top"><i
                                    class="am-icon-user am-icon-fw"></i>欢迎你:{{$data['username']}}</a></div>
                </div>
                <div class="topMessage my-shangcheng">
                    <div class="menu-hd MyShangcheng"><a href="{{asset('/account/logout')}}" target="_top"><i
                                    class="am-icon-outdent am-icon-fw"></i>退出</a></div>
                </div>
            @endif
        </ul>
    </div>
    ...
    <div class="nav white">
        ...
        <div class="logoBig" style="margin-top: -15px;margin-left: -50px;">
            <li><img src="{{asset('images/bylh2.png')}}" onclick="gobackhome();" style="margin-left: 167px;"/></li>
        </div>

        <div class="search-bar pr" style="width: 100%;margin-top: -75px;margin-left: 167px;margin-right: -167px;">
...
<div class="shopNav">
    <div class="slideall" style="height: auto;">
        ...
        <div class="long-title"><span class="all-goods"
