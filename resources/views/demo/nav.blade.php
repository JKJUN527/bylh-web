<div class="hmtop">
    ...
    <div class="am-container header">
        ...
        <ul class="message-r">
            <div class="topMessage my-shangcheng">
                <div class="menu-hd MyShangcheng"><a href="/login" target="_top"><i class="am-icon-user am-icon-fw"></i>登录</a></div>
            </div>
            <div class="topMessage my-shangcheng">
                <div class="menu-hd MyShangcheng"><a  href="/register" target="_top"><i class="am-icon-user-plus am-icon-fw"></i>注册</a></div>
            </div>
        </ul>
    </div>
    ...
    <div class="nav white">
        <div class="logo"><img src="images/bylh2.png" /></div>
        <div class="logoBig">
            <li><img src="images/bylh.png" /></li>
        </div>
