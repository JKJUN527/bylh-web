...
@endif
                ...
                <li class="qc @if($title==7 && $subtitle ==1) nav_active @endif"><a href="{{asset('about')}}">关于我们</a>
                </li>
                <li class="qc @if($title==7 && $subtitle ==2) nav_active @endif"><a href="/about?page=qainfo">用户指引</a>
                </li>
            </ul>
        </div>
    @section('content')
