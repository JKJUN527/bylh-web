        ...
        <div class="am-u-lg-12 am-g-u-md-12 am-u-sm-12">
            <div class="fabu1" style="background:#eee;margin-bottom: 10px;height:300px;">
                ...
                <div class="fb_container" style="padding: 16px 3px;margin-left: 10px;padding-bottom: 30px;margin-bottom: 20px;">
                        <label for="doc-ipt-3-a" class="am-form-label" style="font-size: 16px;width:200px;">电话:&nbsp;&nbsp;<span>18581872812</span></label>
                        <br><br><br>
                        <label for="doc-ipt-3-a" class="am-form-label" style="font-size: 16px;width:200px;">邮箱:&nbsp;&nbsp;<span>18581872812@qq.com</span></label><br><br><br>
                        <label for="doc-ipt-3-a" class="am-form-label" style="font-size: 16px;width:200px;">服务类型:&nbsp;&nbsp;<span>大学生服务</span></label><br><br><br>
                        <label for="doc-ipt-3-a" class="am-form-label" style="font-size: 16px;width:200px;">服务类别:&nbsp;&nbsp;<span>家教艺体</span></label>
                </div>
            </div>
